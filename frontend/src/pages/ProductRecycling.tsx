      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div className="relative group">
            <div className="aspect-square bg-gradient-to-br from-cyan-100 to-emerald-100 rounded-3xl overflow-hidden shadow-xl">
              <img
                src={product.image}
                alt={product.name}
              ...
              {/* Recycled Badge */}
              <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-full px-3 py-1 text-xs font-semibold text-cyan-700 shadow-lg flex items-center gap-1">
          ...
          <div className="flex flex-col justify-center space-y-6">
            ...
            {/* Price */}
            <div className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-cyan-600 to-emerald-600 bg-clip-text text-transparent">
              ${product.price}
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="w-10 h-10 rounded-full border border-cyan-300 hover:bg-cyan-50 transition-colors flex items-center justify-center"
                >
                  -
                </button>
            ...
            <Button
              ...
              className="bg-gradient-to-r from-cyan-600 to-emerald-600 hover:from-cyan-700 hover:to-emerald-700 text-white py-4 text-lg font-semibold tracking-wide w-full sm:w-auto"
            >
              ...
              <ul className="space-y-3">
                {product.features.map((feature, index) => (
                  <li key={index} className="flex items-start gap-3">
                    <CheckCircle className="text-cyan-600 mt-0.5 flex-shrink-0 w-5 h-5" />
